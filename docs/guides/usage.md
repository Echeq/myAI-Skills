...
[📂 Welcome](/docs/WELCOME.md) • [📂 Skill Index](/docs/README.md) • [📂 Agent Index](/docs/agents/README.md)
...
> [!TIP]
> After installing, run `@ai-docs` to regenerate the documentation index so the new skill appears.
