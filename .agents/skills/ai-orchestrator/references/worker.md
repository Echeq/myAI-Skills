...
**If the task says "save this plan", "persist this document", or mentions writing a `.md` file to `.agents/memory/ai-orchestrator/assets/plan/` or `.agents/memory/ai-orchestrator/assets/state/`:**
